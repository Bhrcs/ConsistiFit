...
for (const asset of ['manifest.webmanifest','demo-app.js','plan-builder.js','exercise-library.js','workout-nav.js','demo-depth.js','styles.css','plan-builder.css','exercise-guides.css','workout-nav.css','demo-depth.css']) {
  assert(html.includes(asset), `index missing ${asset}`);
}
assert(manifest.name === 'ConsistiFit');
assert(manifest.display === 'standalone');
for (const asset of ['./demo-app.js','./plan-builder.js','./exercise-library.js','./workout-nav.js','./demo-depth.js','./styles.css','./plan-builder.css','./exercise-guides.css','./workout-nav.css','./demo-depth.css']) {
  assert(sw.includes(asset), `service worker missing ${asset}`);
}
assert(sw.includes('consistifit-playable-v7'));
